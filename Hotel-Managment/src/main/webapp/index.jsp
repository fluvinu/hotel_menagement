...
<body>
    ...
    <div>
        ...
        <a href="http://localhost:8080/Hotel-Managment/admin/Login.jsp"> <button id="btn" class="button btn btn-outline-dark" >
        ADMIN</button> </a>
        
         <br> <br>
        
        <a href="http://localhost:8080/Hotel-Managment/user/Login.jsp"> <button id="btn" class="button btn btn-outline-dark" style="color: white;" >
        CUSTOMER</button> </a>
